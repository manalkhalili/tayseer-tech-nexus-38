    ...
    <Layout>
      ...
      <section className="relative h-screen flex items-center justify-center">
        <div className="absolute inset-0 bg-tayseer-black">
          ...
          <div 
            ...
            style={{ backgroundImage: "url('https://images.unsplash.com/photo-1497436072909-60f360e1d4b1?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2560&q=80')" }}
          ></div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              <SectionTitle
                ...
                subtitle="Leading the way in renewable energy and green technologies"
              />
            ...
            <div className="rounded-lg overflow-hidden shadow-lg">
              <img
                src="https://images.unsplash.com/photo-1508515803898-7bb2d7703093?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1334&q=80"
      ...
      <section className="section-padding section-gray">
        <div className="container-max">
          <SectionTitle
            title="Our Services"
            subtitle="Specialized solutions for a sustainable future"
            centered={true}
          />
      ...
      <section className="section-padding section-dark">
        <div className="container-max">
          <SectionTitle
            ...
            subtitle="Specialized teams delivering excellence in their fields"
            centered={true}
            light={true}
          />
