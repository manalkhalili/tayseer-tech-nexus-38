...
const Services = () => {
  ...
  return (
      <Layout>
        ...
        {/* Detailed Services by Department */}
              ...
              {departments.map((department, index) => (
                  <div key={department.id} id={department.id} className="bg-white rounded-lg shadow-lg overflow-hidden">
                    <div className="flex flex-col lg:flex-row gap-8">
                      {/* Department Image - Made smaller and responsive */}
                      <div className="lg:w-1/4 flex-shrink-0 flex items-center justify-center p-4">
                        <div className="w-32 h-32 sm:w-40 sm:h-40 md:w-48 md:h-48 lg:w-32 lg:h-32 xl:w-40 xl:h-40">
                          <img
